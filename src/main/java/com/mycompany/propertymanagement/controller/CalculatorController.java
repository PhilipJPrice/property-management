...
@RestController
@RequestMapping("/api/v1/calculator") //class level mapping url to a controller class
public class CalculatorController {

    //http://localhost:8089/api/v1/calculator/add
    //http://localhost:8089/api/v1/calculator/add?num1=4.5&num2=2.2
